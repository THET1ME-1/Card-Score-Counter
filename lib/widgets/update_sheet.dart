...
/// предлагает открыть страницу релиза в браузере.
class UpdateSheet extends StatefulWidget {
  ...
  /// Показывает меню обновления снизу экрана.
...
class _UpdateSheetState extends State<UpdateSheet> {
  ...
  Future<void> _startUpdate() async {
    ...
    // Нет прямого APK — открываем релиз в браузере.
    if (url == null) {
      await _openGithub();
    ...
    // меню оставляем открытым (пользователь вернётся уже на новой версии).
  }
