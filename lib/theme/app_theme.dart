...
class AppTheme {
  ...
  ///
  /// Умолчание Flutter — `tonalSpot` — специально «пастелит»: срезает
  /// насыщенность до фиксированного низкого уровня, из-за чего любой выбранный
  /// цвет выходит приглушённым, а разные пресеты выглядят похоже.
